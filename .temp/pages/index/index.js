    ...
    return <View className="index-page">
				...
				<AtTabs current={this.state.current} tabList={tabList} onClick={this.handleClick.bind(this)}>
					<AtTabsPane current={this.state.current} index={0}>
						<View>
							<View id="mescroll" className="scrollView mescroll news-list" scrollY scrollWithAnimation scrollTop="0" lowerThreshold="10" upperThreshold="10">
								<View>
									{list.map(() => {
                  return <View className="scrollView-item" style={{
                    ...this.randomRgb()
                  }}></View>;
                })}
								</View>
